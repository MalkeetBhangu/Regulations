...
export default class Login extends Screen {
  ...
  isLoginOffline() {
    ...
    // AsyncStorage.getItem('offlineToken')=>{
    AsyncStorage.getItem('offlineToken').then(token => {
        ...
        <ScrollView
          ...
          <ImageBackground
            ...
            {/* <NetworkError
              ...
              search={() => this.props.navigation.navigate('SearchTabs')}
              // searchIcon={()=>this.props.navigation.navigate('SearchTabs')}
            /> */}
            ...
            <View
              ...
              {this.state.showLoginWithoutInternet && (
                <TouchableOpacity
                  ...
                  <Text style={styles.enableButton}>
                    {/* Σύνδεσηχωρίς */}
                    {/* change by akriti*/}
                    {/* Είσοδοςχωρίςσύνδεση Internet */}
                    Είσοδος χωρίς σύνδεση Internet
                  </Text>
                </TouchableOpacity>
              )}
            </View>
